function Camera(cameraPostion, cameraDirection, cameraUp, cameraYaw, cameraPitch) {
	...
	this.projectionMatrix = perspective(45, canvas.width / canvas.height, 0.5, 10000);
	...
	// 	//console.log(events.moveForward);
	//
	// 	if (events.moveForward) {
	// 		this.moveForward(0.1);
	// 	}
	// 	if (events.moveBackward) {
	// 		this.moveBackward(events.curSpeed);
	// 	}
	// 	if (events.moveLeft) {
	// 		this.moveLeft(events.curSpeed);
	// 	}
	// 	if (events.moveRight) {
	// 		this.moveRight(events.curSpeed);
	// 	}
	// };
